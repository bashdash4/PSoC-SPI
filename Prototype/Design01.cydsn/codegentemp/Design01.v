...
module SPI_Slave_v2_70_1 (
	...
	cy_clock_v1_0
		#(.id("ffc8f5a3-c9af-4ebd-8f66-a95e75e32012/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("500000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__SS_00_net;
	wire [0:0] tmpFB_0__SS_00_net;
	wire [0:0] tmpIO_0__SS_00_net;
	wire [0:0] tmpINTERRUPT_0__SS_00_net;
	electrical [0:0] tmpSIOVREF__SS_00_net;

	cy_psoc3_pins_v1_10
		#(.id("a0e6ffd6-d2b8-41af-b32f-2b022f472bde"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		SS_00
		 (.oe(tmpOE__SS_00_net),
		  .y({Net_113}),
		  .fb({tmpFB_0__SS_00_net[0:0]}),
		  .io({tmpIO_0__SS_00_net[0:0]}),
		  .siovref(tmpSIOVREF__SS_00_net),
		  .interrupt({tmpINTERRUPT_0__SS_00_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SS_00_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("ef4a20b4-94df-4b49-b9c1-56a705434621"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("376f4e13-4137-4a43-afb6-b98935d3f968"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("44725959-2d2c-4e6e-a7d1-7c9cdebe85c1"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7dc53757-bd54-4cc7-ac88-5d65fbdcb76a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("46bf8c04-fdfd-4f33-a39d-95076df6b6e4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6823a148-1d2e-4f81-8ebe-061dc64ba365"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("39537520-4f2f-49a4-91f5-8d9eb42d0603"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__SS_01_net;
	wire [0:0] tmpFB_0__SS_01_net;
	wire [0:0] tmpIO_0__SS_01_net;
	wire [0:0] tmpINTERRUPT_0__SS_01_net;
	electrical [0:0] tmpSIOVREF__SS_01_net;

	cy_psoc3_pins_v1_10
		#(.id("be99501f-741e-4981-9e15-59dd3a770da5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		SS_01
		 (.oe(tmpOE__SS_01_net),
		  .y({Net_114}),
		  .fb({tmpFB_0__SS_01_net[0:0]}),
		  .io({tmpIO_0__SS_01_net[0:0]}),
		  .siovref(tmpSIOVREF__SS_01_net),
		  .interrupt({tmpINTERRUPT_0__SS_01_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SS_01_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    begin : demux_1
        ...
        always @(Net_117 or Net_100)
        begin
            case (Net_100)
                1'b0:
                begin
                    tmp__demux_1_0_reg = Net_117;
                    tmp__demux_1_1_reg = 1'b0;
                end
                1'b1:
                begin
                    tmp__demux_1_0_reg = 1'b0;
                    tmp__demux_1_1_reg = Net_117;
                end
            endcase
        end
        assign Net_113 = tmp__demux_1_0_reg;
        assign Net_114 = tmp__demux_1_1_reg;
    end
    // -- De Mux end --
